    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          <h2 className="text-center font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
            Testimonial Template!
          </h2>
          <p className="text-center mt-4 text-lg tracking-tight text-slate-700">
           Template text. Template text. Template text. Template text. Template text. Template text. Template text. Template text. Template text.
          </p>
        </div>
        <ul
