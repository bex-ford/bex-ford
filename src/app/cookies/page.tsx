  ...
  return (
    <>
      <div className="flex flex-col gap-4 p-8 max-w-7xl mx-auto">
        <h1 className="text-4xl">Cookie Policy for template.co.uk</h1>
        <p>This is the Cookie Policy for template.co.uk, accessible from https://template.co.uk/</p>
        <div>
          <p className="text-lg"><strong>Note</strong></p>
          <p>This site uses cookies for Google Analytics which is opted-in when you press {'"'}Allow Cookies{'"'}. The rest of
            this page was generated with <a target="_blank" href="https://www.termsfeed.com/cookies-policy-generator/">Cookies
              Policy Generator</a>.</p>
        </div>

        <div>
          <p className="text-lg"><strong>What Are Cookies</strong></p>
        ...
        <div>
          <p className="text-lg"><strong>How We Use Cookies</strong></p>
        ...
        <div>
          <p className="text-lg"><strong>Disabling Cookies</strong></p>
          <p>You can prevent the setting of cookies by adjusting the settings on your browser (see your browser Help for
            ...
            with the help of the <a target="_blank" href="https://www.termsfeed.com/cookies-policy-generator/">Cookies
              Policy Generator</a>.</p>
        </div>

        <div>
          <p className="text-lg"><strong>The Cookies We Set</strong></p>
          <ul>
            <li>
        ...
        <div>
          <p className="text-lg"><strong>Third Party Cookies</strong></p>
